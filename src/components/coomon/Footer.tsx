    ...
    <footer className="bg-black text-white pt-16 pb-6 px-6 relative">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center mb-12 max-w-4xl">
          ...
          <button className="mt-5 text-[13px] font-Semibold hover:text-cyan-400 uppercase">Give us Feedback</button>
        </div>
        ...
        <div className="w-full text-center text-[12px] text-gray-100 uppercase space-y-2 mb-10 border-t border-gray-800 pt-8">
          <p className="flex flex-wrap justify-center gap-2">
            Graphic Design Company in Noida <span className="text-gray-300">|</span> Google-Adwords Company in Noida <span className="text-gray-300">|</span> Ecommerce Development Company in Noida <span className="text-gray-700">|</span> Digital Marketing Company in Noida <span className="text-gray-700">|</span> Social Media Agency in Noida
          </p>
          <p className="flex flex-wrap justify-center gap-2">
            SEO Company in Noida <span className="text-gray-300">|</span> Website Design Company in Noida <span className="text-gray-300">|</span> Google Ads Management Company <span className="text-gray-700">|</span> Marketplace Management Services <span className="text-gray-700">|</span> Digital Marketing for Manufacturers
          </p>
        </div>
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-6 py-10 border border-gray-800 px-6">
          ...
          <div className="md:col-span-4 text-base space-y-3 md:pl-10 pt-2 border-l border-gray-800">
            <p className="text-gray-100"><span className="text-gray-400 ">US:</span> +1(832)802-4342</p>
            <p className="text-gray-100"><span className="text-gray-400">IND:</span> +91- 956-078-5068</p>
            <p className="text-gray-100"><span className="text-gray-400">Support:</span> support@digitalxplode.com</p>
            <p className="text-gray-100"><span className="text-gray-400">Enquiry:</span> info@digitalxplode.com</p>
          </div>
        </div>
        ...
        <div className="w-full mt-10 pt-6 border-t border-gray-900 flex flex-col md:flex-row justify-between items-center text-[11px] text-gray-400 gap-4">
          ...
          <div className="flex gap-4">
            ...
            <span>|</span>
            <Link href="/refund" className="hover:text-white transition">Refund & Cancellation Policy</Link>
          </div>

          <div className="flex gap-4 items-center">
            <Link href="#" className="hover:scale-110 transition"><Twitter size={18} fill="currentColor" /></Link>
            <Link href="#" className="hover:scale-110 transition text-blue-600"><Facebook size={18} fill="currentColor" /></Link>
            <Link href="#" className="hover:scale-110 transition text-pink-600"><Instagram size={18} /></Link>
            <Link href="#" className="hover:scale-110 transition text-blue-500"><Linkedin size={18} fill="currentColor" /></Link>
          </div>
        </div>
      </div>
